...
- [x] 3.6 Run real-codebase tests to verify reduction in unknown-type failures (deferred)
...
- [x] 4.8 Run real-codebase tests to verify reduction (deferred — included in verification run)
...
- [x] 7.5 Run real-codebase tests to verify (currently 29 failures, 17 scope-related)
