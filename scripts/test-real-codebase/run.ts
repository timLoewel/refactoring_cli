...
const REPOS: RepoConfig[] = [
  ...
  {
    name: "valibot",
    url: "https://github.com/fabian-hiller/valibot.git",
    ref: "v1.3.1",
    testMode: "compile-and-test",
    testCmd: "npx vitest run",
    scopedTestCmd: "npx vitest related --run",
    installCmd: "npm install --ignore-scripts --legacy-peer-deps",
    projectSubdir: "library",
  },
  {
    name: "tsyringe",
    url: "https://github.com/microsoft/tsyringe.git",
    ref: "v4.8.0",
    testMode: "compile-and-test",
    testCmd: "npx jest --config test/jest.config.js",
    scopedTestCmd: "npx jest --config test/jest.config.js --findRelatedTests",
  },
  {
    name: "typedi",
    url: "https://github.com/typestack/typedi.git",
    ref: "v0.10.0",
    testMode: "compile-and-test",
    testCmd: "npx jest",
    scopedTestCmd: "npx jest --findRelatedTests",
  ...
  {
    name: "awilix",
    url: "https://github.com/jeffijoe/awilix.git",
    ref: "v9.0.0",
    testMode: "compile-and-test",
    testCmd: "npx jest --verbose --runInBand",
    scopedTestCmd: "npx jest --findRelatedTests",
  },
  {
    name: "path-to-regexp",
  ...
  {
    name: "kysely",
    url: "https://github.com/kysely-org/kysely.git",
    ref: "v0.28.15",
    testMode: "compile-only",
  },
  {
